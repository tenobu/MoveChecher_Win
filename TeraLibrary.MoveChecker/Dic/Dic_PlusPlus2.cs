...
namespace TeraLibrary.徳島_勤怠チェック.Dic
{
	...
	// Dic_Plusは現行バージョン
	//
	public class Dic_PlusPlus2 : Dictionary<string, int>
	{
		...
		protected Dictionary<string, Dictionary<string, object>> dicDatas;

		protected List<string> listエラー = null;


		public Dic_PlusPlus2()
		{
			//var func_title = "Dic_PlusPlus2.Dic_PlusPlus2()";
		...
		public Dictionary<string, Dictionary<string, object>> DicDatas
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.DicDatas(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual string Alphabet
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.Alphabet(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual int TopCount
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.TopCount(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual int ColumnCount
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.ColumnCount(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual int RowsCount
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.RowsCount(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.RowsCount(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual int RowsOld
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.RowsOld(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.RowsOld(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual int RowIndex
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.RowIndex(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.RowIndex(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual object[,] ObjDatas
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.ObjDatas(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.ObjDatas(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual string SyainNO
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.SyainNO(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.SyainNO(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		public virtual Boolean SwichFlag
		{
			get
			{
				//var func_title = "Dic_PlusPlus2.SwichFlag(get)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
			...
			set
			{
				//var func_title = "Dic_PlusPlus2.SwichFlag(set)";
				//Console.WriteLine(func_title + " Start");
				//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.InitDicDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
			...
			dicDatas = new Dictionary<string, Dictionary<string, string>>();
		...
		{
			//var func_title = "Dic_PlusPlus2.EndDicDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.AddListDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetListDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveRead2()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveWrite2()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveRewrite2()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ReadNext()";
			//Console.WriteLine(func_title + " Start");
		//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.Find()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.Find2()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetDicDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ResetDicDatas()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveRead()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveWrite()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ColumnMoveRewrite()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetKeyValue()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.GetValue()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ToString()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.CopySyainNO()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ErrorCheck()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.ToError()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetClear()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetFormatLocal()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
		...
		{
			//var func_title = "Dic_PlusPlus2.SetRangeTo()";
			//Console.WriteLine(func_title + " Start");
			//Message.Information(func_title + " Start");
